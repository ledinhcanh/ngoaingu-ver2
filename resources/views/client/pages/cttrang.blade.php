...
<div class="container">
    ...
    <div class="col-lg-8 ftco-animate eimg" style="color:#000000;">
        <h2 class="mb-2">{{ $trang->title }}</h2>
        <div class="fb-like mb-3" data-href="http://127.0.0.1:8000/tin/{{ $trang->slug }}" data-width="" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
        {!! $trang->content !!}
        <div class="fb-comments" data-href="http://127.0.0.1:8000/tin/{{ $trang->slug }}" data-width="730" data-numposts="5" style=""></div>
    </div> <!-- .col-md-8 -->
